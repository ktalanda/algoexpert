def numberOfWaysToTraverseGraphRec(width, height):
    if width == 1 or height == 1:
        return 1

    return numberOfWaysToTraverseGraphRec(width - 1, height) + numberOfWaysToTraverseGraphRec(width, height - 1)
...
def numberOfWaysToTraverseGraphMath(width, height):
